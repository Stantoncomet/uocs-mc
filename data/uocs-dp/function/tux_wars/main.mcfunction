...
execute if score resin_brickGen timeLeft matches ..0 run execute as @e[tag=resin_brickGen] at @s run function uocs-dp:tux_wars/generate {id:"resin_brick",cap:48}
...
execute if score emeraldGen timeLeft matches ..0 run execute as @e[tag=emeraldGen] at @s run function uocs-dp:tux_wars/generate {id:"emerald",cap:8}
